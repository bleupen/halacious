 ...
 * @return {Representation}
 */
Representation.prototype.ignore = function(...args) {
...
Representation.prototype.toJSON = function() {
  ...
  let payload = { _links: this._links };
  let self = this;
...
Representation.prototype.embed = function(rel, self, entity) {
  ...
  let embedded = this.factory.create(entity, self, this._root);
