...
// see http://tools.ietf.org/html/draft-kelly-json-hal-06#section-8.2
    ...
    internals.link = function (link, relativeTo) {
        ...
        if (relativeTo && (internals.isRelativePath(link.href) || settings.absolute ) && !(!internals.isRelativePath(link.href) && link.href.includes(relativeTo))) {
            link.href = internals.buildUrl(undefined, decodeURIComponent(url.resolve(relativeTo+'/', link.href)));
        }
        return link;
    };
